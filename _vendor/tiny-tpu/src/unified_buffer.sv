    ...
    always @(posedge clk or posedge rst) begin
        if (rst) begin
            ...
            for (int i = 0; i < SYSTOLIC_ARRAY_WIDTH; i++) begin
                ...
                value_old_in[i] <= '0;
                // grad_descent_valid_in is purely combinational (driven by always_comb)
                // It will automatically be 0 when counters are reset
            end
            ...
            // READ COMMAND INITIALIZATION (moved from always_comb to fix multi-driver issue)
